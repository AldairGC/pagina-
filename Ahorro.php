...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98" style="background:#f7f7f7;">
	...
	<!-- end ahorro -->
	<div >
	<form  style="display: block;padding: 5% 30% 5%; padding-top:1px; background:#f7f7f7;">
	...
	<p id="money" style="text-align:center; font-size:2rem">hola</p>
	<br>
	<p style="text-align:center; font-size:2rem">holax2</p>
	</div>
	<script>
	function opendat() {
		var ingreso = document.getElementById('ingreso').value;
		var gastosG = document.getElementById('gastos').value;
		console.log (ingreso, gastosG);
		if(ingreso > gastosG)
		{
			document.getElementById("money").is_nan = result;
			var result = ingreso - gastos;
  			document.getElementById("datos").style.display = "block";
		}
		else
		{
			document.getElementById("datos").style.display = "none";
			alert("ingreso mensual demasiado bajo")
		}
	}
	</script>
	<!-- invercio -->
